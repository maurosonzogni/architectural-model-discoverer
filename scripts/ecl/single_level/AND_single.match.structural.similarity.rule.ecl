...
rule CompareByName
    ...
    with secondModel: SecondModel!SystemInstance {
        ...
        guard : true
        // AND compare
        compare: (checkElementSimilarity(firstModel.componentInstance, secondModel.componentInstance, componentWeigth) and checkElementSimilarity(firstModel.connectionInstance,secondModel.connectionInstance, connectionWeigth) and checkElementSimilarity(firstModel.featureInstance,secondModel.featureInstance,featureWeigth) and checkElementSimilarity(firstModel.flowSpecification,secondModel.flowSpecification, flowSpecificationWeigth))
        do {
            "DO...".println();
            ...
            structuralDistance = (componentDistance + connectionDistance + featureDistance + flowSpecificationDistance).asDouble();
...
operation checkElementSimilarity(elementsFirstModel: Any, elementsSecondModel: Any, elementsWeigth: Real): Boolean{
    "Check element similarity:".println();
